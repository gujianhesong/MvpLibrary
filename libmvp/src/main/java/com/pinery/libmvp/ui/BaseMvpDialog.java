...
public abstract class BaseMvpDialog<P extends BasePresenter, M extends BaseModel> extends Dialog {
  ...
  protected BaseMvpDialog(@NonNull Context context, boolean cancelable,
